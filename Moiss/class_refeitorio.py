...
class Refeitorio:
    ...
    def verificar_capacidade(self):
        try:
            ...
            print(f"O refeitório esta com a capacidade: {capacidade_atual}/{self.capacidade_maxima}")
            ...
            print(f"Ocorreu um erro ao verificar a capacidade: {e}")
    ...
    def tentar_entrar(self, usuario, dia_atual, hora_atual):
        try:
            ...
            print(f"Erro de Atributo: {e}. Verifique os dados do usuário.")
            print(f"Ocorreu um erro ao tentar entrar no refeitório: {e}")
    ...
    def sair(self, usuario):
        try:
            ...
            print(f"Erro de Valor: {e}. O usuário não foi encontrado na lista.")
        except Exception as e:
            print(f"Ocorreu um erro ao sair do refeitório: {e}")
...
def validar_hora(hora):
    try:
        ...
        print(f"Ocorreu um erro ao validar a hora: {e}")
        return False
